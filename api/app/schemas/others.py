...
class Index(BaseModel):
    ...
    similarity: IndexSimilarity = Field(default=IndexSimilarity.bm25, description="The similarity algorithm to use for the search.")
    institution: str | None = None
    sources: list[str] | None = Field(default=None, description="Restrict the list of source to search within.")
